...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "liuwu"
  # s.authors            = { "liuwu" => "liuwugui@gmail.com" }
  # s.social_media_url   = "http://twitter.com/liuwu"
  ...
  s.source       = { :git => "https://github.com/liuwu/Welian_Coco_Demo.git", :tag => "0.0.1" }
  ...
  s.source_files  = "Welian_Coco_Demo", "Welian_Coco_Demo/WLKit/*.{h,m}"
