...
@interface _WLNSObjectKVOBlockTarget : NSObject
...
@implementation _WLNSObjectKVOBlockTarget
...
- (void)wl_addObserverBlockForKeyPath:(NSString*)keyPath block:(void (^)(id _Nonnull obj, _Nullable id oldVal, _Nullable id newVal))block {
    ...
    _WLNSObjectKVOBlockTarget *target = [[_WLNSObjectKVOBlockTarget alloc] initWithBlock:block];
    NSMutableDictionary *dic = [self _wl_allNSObjectObserverBlocks];
...
- (NSMutableDictionary *)_wl_allNSObjectObserverBlocks {
